...
public class MainForm extends javax.swing.JFrame {
    ...
    private KelasMahasiswa kelas = new KelasMahasiswa("23 CID B");

    public MainForm() {
    initComponents(); // ini yang membentuk GUI-nya
    setLocationRelativeTo(null); // agar form muncul di tengah layar (opsional)
    setVisible(true); // agar jendela terlihat (penting)
}
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
      String nama = txtNama.getText();
        ...
        // Tampilkan popup
        JOptionPane.showMessageDialog(this, kelas.tampilkanSemuaBiodata(), "Biodata Mahasiswa", JOptionPane.INFORMATION_MESSAGE);
